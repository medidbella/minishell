...
SOURCE_FILES =  execution/builtin_exec.c execution/echo_cd_pwd.c\
				...
				parsing/parsing.c parsing/ft_free.c\
				parsing/get_list_and_cmds.c parsing/parsing_utils.c\
				parsing/get_list_and_cmds_utils.c parsing/quotes_cases.c\
				parsing/quotes_cases_utils.c parsing/ft_expansion.c\
				parsing/ft_expansion_utils_1.c parsing/ft_expansion_utils_2.c\
				parsing/ft_expansion_utils_3.c parsing/errors.c parsing/errors_utils.c\
				parsing/return_value.c parsing/remove_quotes.c parsing/echo_args.c\
				parsing/echo_args_utils.c main.c\
...
$(NAME): $(OBJ_FILES)
	make bonus -C libft/ && cc $(OBJ_FILES) $(LIBFT) $(READ_LINE) -o $(NAME) -g3 -fsanitize=address 
